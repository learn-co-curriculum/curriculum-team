Hi there! This request sounds like an improvement to the Learn platform.
[Raising issues on GitHub][raise] should be reserved for problems with the
curriculum itself (doesn't work, throws a Ruby error, etc.)
...
re-open this issue, provide any additional information you can, and we will try
to discern a proper path to resolution.
